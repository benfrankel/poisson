...
#[test]
fn test_4d_1_80_periodic() {
    test_with_samples::<Vect>(1, 0.8, 100, Periodic);
}
...
#[test]
fn test_4d_10_80_periodic() {
    test_with_samples::<Vect>(10, 0.8, 15, Periodic);
}
...
#[test]
fn test_4d_100_80_periodic() {
    test_with_samples::<Vect>(100, 0.8, 1, Periodic);
}
